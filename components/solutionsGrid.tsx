          ...
          <Row>
            ...
            <Col md={4} className="hidden-md hidden-lg hidden-xl">
              ...
              >
                ...
                <ul>
                  <li>
                    <strong>Remote training for your team</strong>
                  </li>
                  <li>
                    <strong>Code Reviews</strong>
                  </li>
                  <li>
                    <strong>Best Practices Audits</strong>
                  </li>
                  <li>
                    <strong>Custom plugin & Feature Development</strong>
                  </li>
                </ul>
                <RedLine />
                <p>
                  We have packages appropriate for all company sizes. Contact us
                  to learn more.
                </p>
                <br />
                <BigButton
            ...
            <Col md={4} className="hidden-xs hidden-sm">
              ...
              >
                ...
                <ul>
                  ...
                  <li>
                    <strong>Best Practices Workshops</strong>
                  </li>
                  <li>
                    <strong>Custom plugin & Feature Development</strong>
                  </li>
            ...
            <Col md={4}>
              ...
              >
                ...
                <RedLine />
                <p>
                  For larger customers in need of a support contract, we offer
                  an enterprise plan including everything in the Premium plan
                  plus:
                </p>
                <RedLine />
                <ul>
                  ...
                  <li>
                    <strong>Emergency response packages</strong>
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>
                      ...and custom development against Actionhero’s core as
                      needed.
                    </strong>
                  </li>
                </ul>
