          ...
          >
            ...
            <Navbar.Collapse>
              ...
              <Nav pullLeft>
                ...
                <NavItem onClick={this.goTo.bind(this, 'https://actionherojs.threadless.com')}><span onMouseEnter={() => { this.onMouseEnter('/shop') }} onMouseLeave={() => { this.onMouseLeave() }} style={this.linkStyle('/shop')}>Shop</span></NavItem>
              </Nav>
