...
export default class extends DocsPageWithNav {
  constructor (props) {
    ...
    this.state = {
      titleSection: {
        title: 'Operations: Production Notes',
        icon: '/static/images/ops-tools.svg'
      },
      sections: {
        'topology': 'Topology Example',
        'paths': 'Paths and Environments',
        'daemon': 'Daemon',
        'number-of-workers': 'Number of Workers',
        'pidfiles': 'Pidfiles',
        'git': 'Git-Based Deployment',
        'procfile': 'PAAS and Procfile Deployment',
      ...
      <DocsPage sideNav={this.state.sections} titleSection={this.state.titleSection} links={this.state.links} currentSection={this.state.currentSection}>
        <Row>
          <Col md={12}>
            ...
            { this.section('number-of-workers',
              <div>
            ...
            { this.section('git',
              <div>
                <Code language='bash'>{GITDeployment}</Code>
            ...
            { this.section('procfile',
              <div>
                <p>When deploying to a Platform as a Service (PAAS) cluster (like <a href='https://heroku.com'>Heroku</a>, <a href='https://flynn.io'>Flynn</a>, and even some <a href='https://www.docker.com'>Docker</a> deployments), we can offer a few pieces of advice.</p>
            ...
            { this.section('nginx',
              <div>
                <Code>{NGINXAHConfig}</Code>
                <Code language='bash'>{NGINXConf}</Code>
                ...
                <ul>
                  <li>Note the proxy-pass format to the socket: <code>{`proxy_pass http://unix:/path/to/socket`}</code></li>
            ...
            { this.section('redis',
              <div>
                ...
                <p><img width='100%' src='/static/images/redis.png' /></p>
            ...
            { this.section('best-practices',
              <div>
                ...
                <h3>Crashing and Safety</h3>
                <Code language='bash'>{Crashing}</Code>
                <ul>
                ...
                <ul>
                  ...
                  <li>Create a way to view the state of your redis cluster.  Are you running out of RAM?  Are your Queues growing faster than they can be worked?  Checking this information is the key to having a healthy ecosystem. <a href='/docs/core/tasks'>The methods for doing so</a> are available.</li>
