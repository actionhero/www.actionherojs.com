  ...
  render () {
    return (
      <DocsPage titleSection={{
        ...
        <Row>
          <Col md={12}>
            <DocSection id='web' title='Terms and Conditions of this website' />
            <h3>1. Terms</h3>
            ...
            <DocSection id='code' title='ActionHero is released under the Apache License (v2)' />
            <p>ActionHero's licence is <a href='https://github.com/actionhero/actionhero/master/LICENSE.txt'>distributed with the code.</a></p>
