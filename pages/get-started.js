  ...
  render () {
    return (
      <DocsPage sideNav={this.sideNav()}>
        ...
        <Row>
          <Col md={12}>
            <h2 id='who'>Who is the ActionHero?</h2>
            ...
            <h2 id='notes'>Documentation Notes</h2>
            ...
            <h2 id='quickstart'>Install and Quickstart</h2>
            <p>Get started now:</p>
            ...
            <h2 id='structure'>Application Structure</h2>
