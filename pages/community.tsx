      ...
      >
        <Row>
          <Col md={5} style={{ paddingTop: 50, paddingBottom: 50 }}>
            ...
            <a href="https://slack.actionherojs.com">
              <img
                style={communityIcon}
                src="/static/images/community/slack.svg"
              />
            ...
            <a href="https://twitter.com/actionherojs">
              <img
                style={communityIcon}
                src="/static/images/community/twitter.svg"
              />
        ...
        <Row>
          <Col md={4} style={{ textAlign: "center" }}>
            ...
            <p>
              <br />
              <a href="/static/press-assets/logo.png">PNG</a> |{" "}
              <a href="/static/press-assets/logo.eps">EPS</a> |{" "}
              <a href="/static/press-assets/logo.svg">SVG</a> |{" "}
              <a href="/static/press-assets/logo.pdf">PDF</a>
            </p>
          </Col>
          ...
          <Col md={4} style={{ textAlign: "center" }}>
            ...
            <p>
              <br />
              <a href="/static/press-assets/wordmark.png">PNG</a> |{" "}
              <a href="/static/press-assets/wordmark.svg">SVG</a>
            </p>
          </Col>
